 ...
 */
const supportedPollyVoiceNames = {
    'ja-JP': ['Mizuki', 'Takumi'],
    'en-US': ['Ivy', 'Joanna', 'Joey', 'Justin', 'Kendra', 'Kimberly', 'Matthew', 'Salli'],
    'en-AU': ['Nicole', 'Russell'],
    'en-CA': ['Ivy', 'Joanna', 'Joey', 'Justin', 'Kendra', 'Kimberly', 'Matthew', 'Salli'],
 ...
 * @param lang
 */
const getLangSSML = (text, lang = getRandomLanguage()) => {
 ...
 * @param lang
 */
const getLangNameByCode = (code, lang = 'ja-JP') => {
    if (lang === 'ja-JP') {
        if (/^en/.test(code))
            return '英語';
        if (/^es/.test(code))
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const getPersistentAttributes = (handlerInput, defaultAttributes) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
const enqueueProgressiveResponse = (handlerInput, speech, errorHandler) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @param request
 */
const hasAPL = (request) => {
    const interfaces = askSdkCore.getSupportedInterfaces(request);
...
const isAudioPlayerRequest = (requestEnvelope) => {
 ...
 */
class StateManager {
    static updateState(attributeManager, state) {
        attributeManager.setSessionAttributes(Object.assign(Object.assign({}, attributeManager.getSessionAttributes()), { state }));
    }
    static getCurrentState(attributeManager) {
        const att = attributeManager.getSessionAttributes();
        return att.state || '';
    }
    static resetState(attributeManager) {
        this.updateState(attributeManager, '');
    }
    static isMatchedState(attributeManager, state) {
...
exports.getLangNameByCode = getLangNameByCode;
exports.getLangSSML = getLangSSML;
exports.getLocale = getLocale;
exports.getPersistentAttributes = getPersistentAttributes;
exports.getRandomLangSSML = getRandomLangSSML;
exports.getRandomLanguage = getRandomLanguage;
exports.getRandomMessage = getRandomMessage;
exports.getRandomSpeaker = getRandomSpeaker;
...
exports.supportedPollyVoiceNames = supportedPollyVoiceNames;
