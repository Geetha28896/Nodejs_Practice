...
export declare const isDialogStarted: (handlerInput: HandlerInput) => boolean;
export declare const isDialogInprogress: (handlerInput: HandlerInput) => boolean;
export declare const isDialogCompleted: (handlerInput: HandlerInput) => boolean;
