...
export declare const getDevice: (handlerInput: HandlerInput) => Device | undefined;
export declare const getDeviceId: (handlerInput: HandlerInput) => string | null;
 ...
 * @param request
 */
export declare const hasAPL: (request: RequestEnvelope) => boolean;
