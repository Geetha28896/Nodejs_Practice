import { RequestInterceptor, ResponseInterceptor, ErrorHandler, RequestHandler } from 'ask-sdk';
import { SkillConstants } from '@ask-utils/handlers';
declare type PersistanceType = 'DynamoDB' | 'S3';
...
export declare type SkillConfig<T extends SkillConstants = SkillConstants> = S3SkillConfig<T> | DynamoDBSkillConfig<T>;
